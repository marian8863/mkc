                            ...
                            <?php if (!empty($recent_posts)): ?>
                                <?php foreach ($recent_posts as $post): ?>
                                    <li class="d-flex align-items-center">
                                        <div class="posts-thumb placeholder-glow">
                                            <a href="?site_name=<?php echo urlencode($post['site_name']); ?>&post_id=<?php echo $post['blog_id']; ?>">
                                                <img loading="lazy" alt="img" src="images/news/project1/<?php echo $post['cover_img']; ?>" class="placeholder">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <h4 class="entry-title placeholder-glow">
                                                <a href="?site_name=<?php echo urlencode($post['site_name']); ?>&post_id=<?php echo $post['blog_id']; ?>">
            ...
            <div class="col-lg-8 mb-5 mb-lg-0 order-0 order-lg-1">
                <?php if (!empty($blogs)): ?>
                    <?php foreach ($blogs as $blog_id => $blog): ?>
                        <div class="post placeholder-glow">
                            <div class="post-media post-image">
                                <img loading="lazy" src="images/news/project1/<?php echo $blog['details']['cover_img']; ?>" class="img-fluid placeholder" alt="post-image">
                            </div>
                            ...
                            <div class="post-body">
                                <div class="entry-header">
                                    ...
                                    <h2 class="entry-title placeholder-glow">
                                                            ...
                                                            <div class="col-6 col-lg-4 col-md-6 shuffle-item">
                                                                <div class="project-img-container">
                                                                    <a href="images/news/project1/<?php echo $gallery_img; ?>" data-fancybox="gallery-<?php echo $blog_id; ?>" data-caption="Image <?php echo $index + 1; ?>">
                                                                        <img class="img-fluid placeholder" src="images/news/project1/<?php echo $gallery_img; ?>" alt="project-img">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        <?php endforeach; ?>
