      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-4 col-md-6 footer-widget footer-about">
            ...
            <img loading="lazy" width="200px" class="footer-logo" src="images/footer-logo1.png" alt="Constra">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
            ...
            <ul class="list-arrow">
              <li><a >Masonry works</a></li>
              <li><a >Electrical works</a></li>
              <li><a >Land Surveying</a></li>
              <li><a >Plumbing Works</a></li>
              <li><a >Planning and 3D Elevation</a></li>
            </ul>
          </div><!-- Col end -->
        </div><!-- Row end -->
      </div><!-- Container end -->
          ...
          <div class="col-md-6">
            <div class="copyright-info">
              <span>Copyright &copy;
                ...
                2022, Designed &amp; Developed by <a href="https://www.facebook.com/MKCo2020">JK Solutions</a></span>
            </div>
          </div>
